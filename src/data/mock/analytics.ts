...
const RANGE_BUCKETS: Record<string, { points: number; stepMinutes: number; labelStyle: 'clock' | 'day' }> = {
...
function labelFor(d: Date, style: 'clock' | 'day'): string {
  return style === 'day'
...
export function buildSeries(
  range: string,
  seed: string,
  shape: (rng: () => number, index: number, dayFactor: number) => Record<string, number>,
): TimeSeriesPoint[] {
