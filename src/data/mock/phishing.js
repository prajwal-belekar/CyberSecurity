...
export const PHISHING_SCAN_HISTORY = [
 ...
 */
export function buildIndicatorSet(_url, features) {
    return [
...
export const LAST_ANALYSIS = {
    ...
    recommendation: 'Block this domain at the DNS resolver and mail gateway, notify the reporting user, and check for credential reuse across the estate.',
