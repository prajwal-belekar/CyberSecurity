...
export const BOOT_LINES = [
    { label: 'Initializing interface', state: 'OK' },
    { label: 'Loading threat engine', state: 'OK' },
    { label: 'Loading network monitor', state: 'OK' },
    { label: 'Loading intelligence module', state: 'OK' },
    { label: 'Connecting to event stream', state: 'OK' },
    { label: 'AI subsystem ready', state: 'OK' },
];
/**
 ...
 */
export const ROUTE_LOADING_LABELS = [
