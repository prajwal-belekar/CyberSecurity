...
function build(): AuthenticationEvent[] {
...
export const AUTHENTICATION_EVENTS: AuthenticationEvent[] = build();

export const AUTH_SEQUENCES: AuthSequence[] = [
  {
    id: 'SEQ-0042',
    user: 'admin',
    ip: '192.168.1.42',
...
export const AUTH_SUMMARY: AuthSummary = {
  successful: 1_284,
  failed: 187,
  suspicious: 23,
  lockedAccounts: 4,
