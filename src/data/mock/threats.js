...
function buildAmbientEvents(count) {
    const out = [];
...
export const THREATS = [
    ...
    },
    {
        ...
        description: 'A credential-harvesting page mimicking a corporate single sign-on portal was reported by a user. The domain was registered 4 days ago, uses a free certificate, and posts submitted credentials to an unrelated origin.',
    ...
    },
    {
        ...
        description: 'A service account received password-spray attempts from an external relay that has never appeared in the account history. Attempts stopped abruptly, suggesting an abandoned automated run.',
    ...
    },
    {
        ...
        description: 'Sequential SYN probes across TCP ports 1–1024 from a documentation-range host. No connection was established; all probes were dropped by the perimeter policy.',
    ...
    },
    {
        ...
        description: 'A PE32 executable submitted from WORKSTATION-07 spawned a detached child process, wrote to the Run key for persistence and beaconed to a hard-coded external address. Detonation was completed inside the isolated sandbox.',
    ...
    },
    {
        ...
        description: 'Automated reconnaissance requests against the public application endpoint. Traffic was unauthenticated and produced only informational responses; no injection vector succeeded.',
    ...
    },
    {
        ...
        description: 'Four consecutive failures from a known corporate workstation, followed by a successful MFA challenge. Confirmed with the user as a mistyped password after a keyboard layout change.',
        indicators: ['192.168.2.88'],
        relatedEventIds: [],
        recommendedActions: ['No action required — closed as false positive'],
    },
];
export const THREAT_SUMMARY = {
    critical: 3,
    high: 12,
    medium: 27,
    low: 64,
...
export function buildActivitySeries(points, stepMinutes, seed = 'activity') {
