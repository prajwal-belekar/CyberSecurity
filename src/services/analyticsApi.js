...
import { ANALYTICS_HEADLINES, buildSeries, DETECTION_RULE_EFFICACY, INCIDENT_RESOLUTION_MIX, SEVERITY_MIX, THREAT_CATEGORY_MIX, } from '@/data/mock';
import { intBetween, seededRandom } from '@/utils/random';
export const analyticsApi = {
    async bundle(range = '30D') {
        if (!USE_MOCK)
            return apiRequest(ENDPOINTS.analytics, { query: { range } });
